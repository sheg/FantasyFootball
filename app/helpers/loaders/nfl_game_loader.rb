module Loaders
  class NflGameLoader < NflLoader
    ...
    #
    #    puts "Game data updated ExternalID #{nfl_game.external_game_id}, #{season.year}#{get_season_type_name(nfl_game.season_type_id)} Week #{nfl_game.week}, #{away_team.abbr} @#{home_team.abbr}" if nfl_game.changed?
    #
    #    nfl_game.save
    #  end
    #end
    ...
    def load_game_scores
      ...
      nfl_games = NflGame.with_teams.for_season(season.year).to_a
